...
export default function BankDetailsForm({ manufacturerId, existing }: BankDetailsFormProps) {
  const upsert = useUpsertBankDetails();
  const uploadBankDocs = useUploadBankDetailsDocuments();
  ...
  const handleSave = () => {
    ...
    upsert.mutate({ mfgId: manufacturerId, payload: form });
  };
          ...
          <div className="border-t pt-4 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <InlineDocUpload
                ...
                onUpload={(files) =>
                  uploadBankDocs.mutate({ mfgId: manufacturerId, files, docType: "cancelled_cheque" })
                }
